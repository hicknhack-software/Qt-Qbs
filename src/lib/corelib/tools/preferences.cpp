...
{
    return pathList(QStringLiteral("pluginsPath"), (baseDir.endsWith(QStringLiteral("/qbs/plugins")) || baseDir.endsWith(QStringLiteral("\\qbs\\plugins"))) ? baseDir : (baseDir + QStringLiteral("/qbs/plugins")));
}
