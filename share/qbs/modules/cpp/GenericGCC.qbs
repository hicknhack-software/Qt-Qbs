...
CppModule {
    ...
    Group {
        ...
        Rule {
            ...
            inputsFromDependencies: ["dynamiclibrary_symbols", "staticlibrary", "dynamiclibrary_import"].concat(product.cpp.extraLinkInputsFromDependencies)
            outputFileTags: {
        ...
        Rule {
            ...
            inputsFromDependencies: ["dynamiclibrary_symbols", "dynamiclibrary_import", "staticlibrary"].concat(product.cpp.extraLinkInputsFromDependencies)
